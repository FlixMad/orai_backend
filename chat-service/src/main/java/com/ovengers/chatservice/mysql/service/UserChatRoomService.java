...
public class UserChatRoomService {
    ...
    public UserChatRoomDto subscribeToChatRoom(UserChatRoomDto userChatRoomDto) {
        UserChatRoom userChatRoom = UserChatRoom.builder()
                .chatRoomId(userChatRoomDto.getChatRoomId())
                .userId(userChatRoomDto.getUserId())
                .build();

        UserChatRoom savedEntity = userChatRoomRepository.save(userChatRoom);
        return UserChatRoomDto.builder()
                .chatRoomId(savedEntity.getChatRoomId())
